...
### Current Release
#### Centos 7
* `yum install https://github.com/45Drives/cephgeorep/releases/download/v1.2.1/cephgeorep-1.2.1-1.el7.x86_64.rpm`
#### Ubuntu
* `wget https://github.com/45Drives/cephgeorep/releases/download/v1.2.1/cephgeorep_1.2.1-1focal_amd64.deb`
* `dpkg -i cephgeorep_1.2.1-1focal_amd64.deb`
